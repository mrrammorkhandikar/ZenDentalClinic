            ...
            <div className="lg:w-1/2 px-6 mb-12 lg:mb-0">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-1">info@zensmile.com</p>
                    <p className="text-gray-600">appointments@zensmile.com</p>
                  </div>
                </div>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-teal-100 p-3 rounded-full text-teal-600 hover:bg-teal-200 transition-colors">
